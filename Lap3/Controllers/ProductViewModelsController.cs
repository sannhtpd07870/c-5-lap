...
namespace Lap3.Controllers
{
    public class ProductViewModelsController : Controller
    {
        ...
        public ProductViewModelsController(AppDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] ProductViewModel productViewModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] ProductViewModel productViewModel)
        {
